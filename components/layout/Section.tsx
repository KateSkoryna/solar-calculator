...
export default function HeroSectionCover({
  ...
  return (
    <section
      className={`relative w-full min-w-full min-h-screen text-center py-4 sm:py-6 md:py-8 lg:py-8 bg-cover bg-center bg-fixed bg-[url('/forestdark.webp')] ${className}`}
    >
